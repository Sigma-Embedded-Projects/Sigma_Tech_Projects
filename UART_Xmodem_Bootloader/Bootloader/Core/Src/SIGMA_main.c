...
int main(void)
{
  ...
  // Erase the requested Pages
  SIGMA_Iflash_Erase(FLASH_APP_START_ADDRESS);
  // Write Data
  SIGMA_Iflash_Write(FLASH_APP_START_ADDRESS, IFLASH_Write_Buffer, sizeof(IFLASH_Write_Buffer));
  // Read Data
